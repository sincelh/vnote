...
void MarkdownViewerAdapter::setSavedContent(const QString &p_headContent, const QString &p_styleContent, const QString &p_bodyContent)
{
    emit contentReady(p_headContent, p_styleContent, p_bodyContent);
}
