...
namespace vnotex
{
    ...
    public slots:
        ...
        void setSavedContent(const QString &p_headContent, const QString &p_styleContent, const QString &p_bodyContent);
    ...
    signals:
        ...
        void contentReady(const QString &p_headContent, const QString &p_styleContent, const QString &p_bodyContent);
